...
with pd.ExcelWriter('full.xlsx', engine='openpyxl') as writer:
    full.to_excel(writer, index=False)    

full = full.to_excel(r'C:\Users\Nisserine\Desktop\GOAL\Day 11\Fourth\Islamic_Companies_Data_full.xlsx')